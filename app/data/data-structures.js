require = (function(e, t, n) {
  ...
  "data-structures": [function(require, module, exports) {
      ...
      Graph = (function() {
        ...
        Graph.prototype.addEdge = function(fromId, toId, weight) {
          ...
          */
          ...
          // Tree constraint.
          if (this.tree && toNode.parentId != null) {
            return;
          }
          ...
          // Add toNode to member for fromNode lvl (if it now has no children)
          ...
          if (fromId != this.rootId) {
            ...
            if (index > -1) {
              ...
              this._levels[fromNode.parentId].size--;
            }
          }
        ...
        Graph.prototype.calculateStats = function() {
          ...
          while (nodesToVisit.length > 0) {
            var currentNode = this.getNode(nodesToVisit[0].to);
            nodesToVisit.shift();

            if (currentNode._id == this.rootId) {
              currentNode.depth = 0;
            } else {
            ...
            if (children.length > 0) {
              ...
              currentNode.subNodes =
                children.length - this._levels[currentNode._id].size;

              if (this._levels[currentNode._id].size > 0) {
                currentNode.subNodes++;
              }
